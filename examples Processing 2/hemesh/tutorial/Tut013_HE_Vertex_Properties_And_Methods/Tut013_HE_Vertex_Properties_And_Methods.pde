...
WB_Normal3d vn = v.getVertexNormal(); // vertex normal, average of face normals, cached
...
List<HE_Vertex> vertices =v.getNeighborVertices(); // get all neighboring vertices

List<HE_Halfedge> halfedges = v.getHalfedgeStar();// get all halfedges starting in vertex

List<HE_Edge> edges = v.getEdgeStar();// get all edges in vertex

List<HE_Face> faces = v.getFaceStar();// get all faces in vertex
