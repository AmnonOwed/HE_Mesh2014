...
void setup() {
  ...
  WB_Point3d ec = edge.getEdgeCenter(); // edge center

  WB_Normal3d en = edge.getEdgeNormal(); // edge normal, average of face normals

  WB_Vector3d et = edge.getEdgeTangent(); // normalized vector along edge
