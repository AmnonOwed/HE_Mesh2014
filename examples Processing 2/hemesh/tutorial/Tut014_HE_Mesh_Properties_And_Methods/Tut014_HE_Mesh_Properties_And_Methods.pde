...
void setup() {
  ...
  WB_Point3d center= mesh.getCenter(); // center of mesh, cached
  ...
  WB_Point3d[] points=mesh.getVerticesAsPoint(); //Get all vertices as points WB_Point[n]
  ...
  WB_Vector3d v=new WB_Vector3d(100, 100, 100);
  mesh.move(v); // Move mesh by provided coordinates

  WB_Point3d p=new WB_Point3d(100, 100, 100);
  ...
  WB_Point3d q=new WB_Point3d(200, 200, 200);
  ...
  mesh.triangulate();//Split all faces in triangles (with exactly 3 vertices)
