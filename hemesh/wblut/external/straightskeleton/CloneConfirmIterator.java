 ...
 * 
 * An iterator that wraps a set to give an interator that checks for item
 * removal from the original set before returning it. Note that this does not
 * check for addition to the set (you will only get a subset of the objects in
 * the original set, nothing that is added after this iterator is constructed)
 * 
 * @author twak
 */
