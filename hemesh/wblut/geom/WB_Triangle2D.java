...
public class WB_Triangle2D implements Triangle2D {
	 ...
	 *            third point
	 */
	public WB_Triangle2D(final WB_Point p1, final WB_Point p2, final WB_Point p3) {
		this.p1 = p1;
		this.p2 = p2;
		this.p3 = p3;
		update();
	 ...
	 *            copy points?
	 */
	public WB_Triangle2D(final WB_Point p1, final WB_Point p2,
	 ...
	 */
	public void update() {
		a = WB_Distance2D.getDistance(p2, p3);
		b = WB_Distance2D.getDistance(p1, p3);
		c = WB_Distance2D.getDistance(p1, p2);
		...
		degenerate = WB_Epsilon.isZeroSq(WB_Distance2D.getSqDistanceToLine(p1,
				p2, p3));
	}
