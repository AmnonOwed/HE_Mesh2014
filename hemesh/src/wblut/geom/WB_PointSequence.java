...
public class WB_PointSequence implements WB_CoordinateSequence<WB_Point> {
	...
	protected WB_PointSequence() {

	}

	protected WB_PointSequence(final Collection<? extends WB_Coordinate> tuples) {
	...
	protected WB_PointSequence(final WB_Coordinate[] tuples) {
	...
	protected WB_PointSequence(final WB_CoordinateSequence tuples) {
		ordinates = new double[4 * tuples.size()];
		n = tuples.size();
		final int index = 0;
		for (int i = 0; i < 4 * n; i++) {
	...
	protected WB_PointSequence(final double[] ordinates) {
		this.ordinates = ordinates;
		n = ordinates.length / 4;
	}

	protected WB_PointSequence(final double[][] tuples) {
	...
	@Override
	public WB_Point getCoordinate(final int i) {
		if (i >= n) {
			throw (new IndexOutOfBoundsException());
		}
		return geometryfactory.createPoint(ordinates[4 * i],
				ordinates[4 * i + 1], ordinates[4 * i + 2]);
	}
	...
	@Override
	public WB_CoordinateSequence<WB_Point> add(final WB_Coordinate p) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._addSelf(p);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> add(final WB_CoordinateSequence seq,
			final int i) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> add(final double x, final double y,
			final double z) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> addMul(final double f,
	...
	@Override
	public WB_CoordinateSequence<WB_Point> mulAddMul(final double f,
	...
	@Override
	public WB_CoordinateSequence<WB_Point> sub(final WB_Coordinate p) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._subSelf(p);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> sub(final WB_CoordinateSequence seq,
			final int i) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> mul(final double f) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._mulSelf(f);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> div(final double f) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> cross(final WB_Coordinate p) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._crossSelf(p);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> cross(
			final WB_CoordinateSequence seq, final int i) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> normalize() {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._normalizeSelf();
	}

	@Override
	public WB_CoordinateSequence<WB_Point> rescale(final double d) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addSelf(final WB_Coordinate p) {
		final double x1 = p.xd();
		final double y1 = p.yd();
		final double z1 = p.zd();
		int id = 0;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addSelf(
			final WB_CoordinateSequence seq, final int i) {
		final double x1 = seq.get(i, 0);
		final double y1 = seq.get(i, 1);
		final double z1 = seq.get(i, 2);
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addSelf(final double x,
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addMulSelf(final double f,
			final WB_Coordinate p) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _mulAddMulSelf(final double f,
			final double g, final WB_Coordinate p) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _subSelf(final WB_Coordinate p) {
		final double x1 = p.xd();
		final double y1 = p.yd();
		final double z1 = p.zd();
		int id = 0;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _subSelf(
			final WB_CoordinateSequence seq, final int i) {
		final double x1 = seq.get(i, 0);
		final double y1 = seq.get(i, 1);
		final double z1 = seq.get(i, 2);
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _subSelf(final double x,
			final double y, final double z) {
		int id = 0;
		for (int j = 0; j < size(); j++) {
			ordinates[id++] -= x;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _mulSelf(final double f) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _divSelf(final double g) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _crossSelf(final WB_Coordinate p) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _crossSelf(
			final WB_CoordinateSequence seq, final int i) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _crossSelf(final double x,
			final double y, final double z) {
		double x1, y1, z1;
		int id = 0;
		for (int j = 0; j < size(); j++) {
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _normalizeSelf() {
		double invd;
		int id = 0;
		for (int j = 0; j < size(); j++) {
			invd = getLength(j);
	...
	@Override
	public WB_Point addI(final int i, final WB_Coordinate p) {
		return getCoordinate(i)._addSelf(p);
	}

	@Override
	public WB_Point addI(final int i, final WB_CoordinateSequence seq,
			final int j) {
		return getCoordinate(i)._addSelf(seq, j);
	}

	@Override
	public WB_Point addI(final int i, final double x, final double y,
			final double z) {
		return getCoordinate(i)._addSelf(x, y, z);
	}

	@Override
	public WB_Point addMulI(final int i, final double f, final WB_Coordinate p) {
		return getCoordinate(i)._addMulSelf(f, p);
	}

	@Override
	public WB_Point addMulI(final int i, final double f,
			final WB_CoordinateSequence seq, final int j) {
		return getCoordinate(i)._addMulSelf(f, seq, j);
	}

	@Override
	public WB_Point mulAddMulI(final int i, final double f, final double g,
			final WB_Coordinate p) {
	...
	@Override
	public WB_Point subI(final int i, final WB_Coordinate p) {
		return getCoordinate(i)._subSelf(p);
	}

	@Override
	public WB_Point subI(final int i, final WB_CoordinateSequence seq,
			final int j) {
		return getCoordinate(i)._subSelf(seq, j);
	}

	@Override
	public WB_Point mulI(final int i, final double f) {
		return getCoordinate(i)._mulSelf(f);
	}

	@Override
	public WB_Point divI(final int i, final double f) {
	...
	@Override
	public WB_Point crossI(final int i, final WB_Coordinate p) {
		return getCoordinate(i)._crossSelf(p);
	}

	@Override
	public WB_Point crossI(final int i, final WB_CoordinateSequence seq,
			final int j) {
		return getCoordinate(i)._crossSelf(seq, j);
	}

	@Override
	public WB_Point normalizeI(final int i) {
		WB_Point p = getCoordinate(i);
		p._normalizeSelf();
		return p;
	}

	@Override
	public WB_Point rescaleI(final int i, final double d) {
		WB_Point p = getCoordinate(i);
		p._normalizeSelf();
		p._mulSelf(d);
		return p;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addSelfI(final int i,
			final WB_Coordinate p) {
		int id = 4 * i;
		ordinates[id++] += p.xd();
		ordinates[id++] += p.yd();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _addMulSelfI(final int i,
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _mulAddMulSelfI(final int i,
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _subSelfI(final int i,
			final WB_Coordinate p) {
		int id = 4 * i;
		ordinates[id++] -= p.xd();
		ordinates[id++] -= p.yd();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _mulSelfI(final int i, final double f) {
		int id = 4 * i;
		ordinates[id++] *= f;
		ordinates[id++] *= f;
		ordinates[id] *= f;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _divSelfI(final int i, final double g) {
		int id = 4 * i;
		final double ig = 1.0 / g;
		ordinates[id++] *= ig;
		ordinates[id++] *= ig;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _crossSelfI(final int i,
			final WB_Coordinate p) {
		x2 = p.xd();
		y2 = p.yd();
		z2 = p.zd();
	...
	@Override
	public WB_CoordinateSequence<WB_Point> _normalizeSelfI(final int i) {
		int id = 4 * i;
	...
	@Override
	public WB_CoordinateSequence<WB_Point> applyAsPoint(final WB_Transform T) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._applyAsPointSelf(T);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> _applyAsPointSelf(
	...
	@Override
	public WB_CoordinateSequence<WB_Point> applyAsVector(final WB_Transform T) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._applyAsVectorSelf(T);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> _applyAsVectorSelf(
			final WB_Transform T) {
		int id = 0;
		for (int j = 0; j < size(); j++) {
			x1 = ordinates[id++];
	...
	@Override
	public WB_CoordinateSequence<WB_Point> applyAsNormal(final WB_Transform T) {
		final WB_CoordinateSequence<WB_Point> result = getCopy();
		return result._applyAsVectorSelf(T);
	}

	@Override
	public WB_CoordinateSequence<WB_Point> _applyAsNormalSelf(
			final WB_Transform T) {
		int id = 0;
		for (int j = 0; j < size(); j++) {
			x1 = ordinates[id++];
	...
	@Override
	public WB_Point applyAsPointI(final int i, final WB_Transform T) {
		final WB_Point result = geometryfactory.createPoint();
		T.applyAsPoint(this, i, result);
		return result;
	}

	@Override
	public WB_Point applyAsVectorI(final int i, final WB_Transform T) {
		final WB_Point result = geometryfactory.createPoint();
	...
	@Override
	public WB_Point applyAsNormalI(final int i, final WB_Transform T) {
		final WB_Point result = geometryfactory.createPoint();
	...
	@Override
	public WB_PointSequence getSubSequence(final int[] indices) {
		final WB_PointSequence subseq = new WB_PointSequence();
	...
	@Override
	public WB_PointSequence getSubSequence(final int start, final int end) {
		final WB_PointSequence subseq = new WB_PointSequence();
	...
	@Override
	public WB_PointSequence getCopy() {
		final WB_PointSequence subseq = new WB_PointSequence();
