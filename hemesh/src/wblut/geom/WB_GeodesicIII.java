...
public class WB_GeodesicIII {
	...
	private void createMesh() {
		...
		WB_Point p0 = trigrid.getPoint(0, 0);
		WB_Point p1 = trigrid.getPoint(b, c);
		WB_Point p2 = trigrid.getPoint(b + c, c - (b + c));
		WB_Point p;
		WB_Point cp;
		...
		default:
			...
			for (WB_Point point : points5) {
				points.add(T.applyAsPoint(point));
			}
			for (WB_Point point : points6) {
				points.add(T.applyAsPoint(point));
			}
			for (WB_Point point : points15) {
				points.add(T.applyAsPoint(point));
			}
