...
public class WB_M33 {
	...
	return new WB_M33((m11 * n.m11) + (m12 * n.m21) + (m13 * n.m31),
		(m11 * n.m12) + (m12 * n.m22) + (m13 * n.m32), (m11 * n.m13)
			+ (m12 * n.m23) + (m13 * n.m33), (m21 * n.m11)
			+ (m22 * n.m21) + (m23 * n.m31), (m21 * n.m12)
			+ (m22 * n.m22) + (m23 * n.m32), (m21 * n.m13)
			+ (m22 * n.m23) + (m23 * n.m33), (m31 * n.m11)
			+ (m32 * n.m21) + (m33 * n.m31), (m31 * n.m12)
			+ (m32 * n.m22) + (m33 * n.m32), (m31 * n.m13)
			+ (m32 * n.m23) + (m33 * n.m33));
    }
	...
	result.set((m11 * n.m11) + (m12 * n.m21) + (m13 * n.m31), (m11 * n.m12)
		+ (m12 * n.m22) + (m13 * n.m32), (m11 * n.m13) + (m12 * n.m23)
		+ (m13 * n.m33), (m21 * n.m11) + (m22 * n.m21) + (m23 * n.m31),
		(m21 * n.m12) + (m22 * n.m22) + (m23 * n.m32), (m21 * n.m13)
			+ (m22 * n.m23) + (m23 * n.m33), (m31 * n.m11)
			+ (m32 * n.m21) + (m33 * n.m31), (m31 * n.m12)
			+ (m32 * n.m22) + (m33 * n.m32), (m31 * n.m13)
			+ (m32 * n.m23) + (m33 * n.m33));
	...
	return new WB_Point((v.xd() * m.m11) + (v.yd() * m.m12)
		+ (v.zd() * m.m13), (v.xd() * m.m21) + (v.yd() * m.m22)
		+ (v.zd() * m.m23), (v.xd() * m.m31) + (v.yd() * m.m32)
		+ (v.zd() * m.m33));
    }
	...
	return new WB_Point((v.xd() * m.m11) + (v.yd() * m.m21)
		+ (v.zd() * m.m31), (v.xd() * m.m12) + (v.yd() * m.m22)
		+ (v.zd() * m.m32), (v.xd() * m.m13) + (v.yd() * m.m23)
		+ (v.zd() * m.m33));
    }
	...
	return new WB_Vector((v.xd() * m.m11) + (v.yd() * m.m12)
		+ (v.zd() * m.m13), (v.xd() * m.m21) + (v.yd() * m.m22)
		+ (v.zd() * m.m23), (v.xd() * m.m31) + (v.yd() * m.m32)
		+ (v.zd() * m.m33));
    }
	...
	return new WB_Vector((v.xd() * m.m11) + (v.yd() * m.m21)
		+ (v.zd() * m.m31), (v.xd() * m.m12) + (v.yd() * m.m22)
		+ (v.zd() * m.m32), (v.xd() * m.m13) + (v.yd() * m.m23)
		+ (v.zd() * m.m33));
    }
	...
	final WB_M33 I = new WB_M33((m22 * m33) - (m23 * m32), (m13 * m32)
		- (m12 * m33), (m12 * m23) - (m13 * m22), (m23 * m31)
		- (m21 * m33), (m11 * m33) - (m13 * m31), (m13 * m21)
		- (m11 * m23), (m21 * m32) - (m22 * m31), (m12 * m31)
		- (m11 * m32), (m11 * m22) - (m12 * m21));
	I.div(d);
	return I;
    }
