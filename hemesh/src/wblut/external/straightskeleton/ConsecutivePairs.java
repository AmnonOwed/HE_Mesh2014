 ...
 * @author twak
 */
public class ConsecutivePairs<E> implements Iterator<Pair<E, E>>,
		Iterable<Pair<E, E>> {
	List<E> input;
	int a = 0, size;
	boolean loop;
	...
	public Pair<E, E> next() {
		Pair<E, E> out = new Pair<E, E>(input.get(a % size), input.get((a + 1)
				% size));
	...
	public static void main(String[] args) {
		...
		// list.add( 4 );
		// list.add( 5 );
		for (Pair<Integer, Integer> t : new ConsecutivePairs<Integer>(list,
				true)) {
